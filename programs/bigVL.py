...
# BigVL is to BigVoicing as VL is to Voicing. That is, BigVL groups two
# BigVL objects. This class is not fully developed, but can be adapted
# for more advanced analysis of implicit voice-leadings in Beethoven.
class BigVL():
...
def main():
	mvt = getProgs.load("/Users/truszala/Documents/1JuniorSpring/python!/Music/Beethoven Quartets/op18_no1_mov2")
	...
	mvt5 = getProgs.load("/Users/truszala/Documents/1JuniorSpring/python!/Music/Beethoven Quartets/op18_no5_mov1")
