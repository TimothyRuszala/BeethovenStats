...
# Has bug: adds duplicate pitches when the same pitch appears in two different instruments at any time.
class BigVoicing():
	...
	# For now only checks the following type: All instruments have exactly one voice, works with 2-4 voices.
...
def main():
	...
	#p. 103
	mvt6 = JPa.load("/Users/truszala/Documents/1JuniorSpring/python!/Music/Beethoven Quartets/op18_no6_mov1")
